...
MACRO_CONFIG_INT(SvTeleportKill, sv_teleport_kill, 0, 0, 1, CFGFLAG_SERVER, "[Not implemented]Teleporting one someone kills him")
...
MACRO_CONFIG_INT(SvHammerDamage, sv_hammer_damage, 1, 0, 1, CFGFLAG_SERVER, "Enable damage from hammer")
...
MACRO_CONFIG_INT(SvWaterInsta, sv_water_insta, 0, 0, 1, CFGFLAG_SERVER, "insta gib")
MACRO_CONFIG_INT(SvWaterStrip, sv_water_strip, 1, 0, 1, CFGFLAG_SERVER, "if using insta gib, strip weapon first")
MACRO_CONFIG_INT(SvWaterFreezetime, sv_water_freezetime, 60, 0, 100000, CFGFLAG_SERVER, "if using insta gib, freeze time the hammer freezes you (50=1 sec, 100 = 2 sec, ...)")
